...
define config.name = _("Last summer")
...
define config.version = "2.0 Beta"
...
define gui.about = _p("""
Спасибо всем тем кто обратил своё внимание на Last summer.
Это был мой первый проэкт в игровой индустрии и я надеюсь что не последний из
моих проэкто.
...
define config.save_directory = "Lastsummer-1649688528"
